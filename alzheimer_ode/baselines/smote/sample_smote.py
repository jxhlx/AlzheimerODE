...
def sample_smote(
    ...
    if change_val:
        ...
        X_num['train'], X_cat['train'], y['train'] = data.read_pure_data(real_data_path, 'train')
        X_num['val'], X_cat['val'], y['val'] = data.read_pure_data(real_data_path, 'val')
    X_num['test'], X_cat['test'], y['test'] = data.read_pure_data(real_data_path, 'test')
