...
DEFAULT_DATA_DIR = Path(__file__).resolve().parents[1] / 'data' / 'Tau'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--alpha', type=float, default=0.7, help='weight of cohort-level noise, range: (0, 1)')
    parser.add_argument('--dir', type=str, default=str(DEFAULT_DATA_DIR))
    parser.add_argument('--gpu', type=int, default=None)
    parser.add_argument('--data_min', type=float, default=0.686, help='minimum value of Tau')
    parser.add_argument('--data_max', type=float, default=4.47, help='maximum value of Tau')
    parser.add_argument('--age_min', type=float, default=60.1, help='minimum value of ADNI+Oasis Tau age')
    parser.add_argument('--age_max', type=float, default=91.1, help='maximum value of ADNI+Oasis Tau age')
