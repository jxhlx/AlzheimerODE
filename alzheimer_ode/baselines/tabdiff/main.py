...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp_name', type=str, default='third', help='Experiment name, used to name log directories and the wandb run name')
    ...
    parser.add_argument('--num_samples_to_generate', type=int, default=46, help='Number of samples to be generated while testing')
    parser.add_argument('--ckpt_path', type=str, default=None, help='Path to the model checkpoint to be tested')
    parser.add_argument('--report', default=True, action='store_true', help="Report testing mode: this mode sequentially runs <num_runs> test runs and report the avg and std")
