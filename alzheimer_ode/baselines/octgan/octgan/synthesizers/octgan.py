...
from octgan.synthesizers.transformers import BGMTransformer, DataTransformer
...
class OCTGANSynthesizer(BaseSynthesizer):
    ...
    def fit(self, train_data, discrete_columns):
        ...
        data_sampler = Sampler(train_data, self.transformer.output_info_list)

        data_dim = self.transformer.output_dimensions
        self.cond_generator = Cond(train_data, self.transformer.output_info_list)
        ...
        for i in range(self.epochs):
            ...
            for id_ in range(steps_per_epoch):
                ...
                fake = self.generator(fakez)
                fakeact = apply_activate(fake, self.transformer.output_info_list)
                ...
                if condvec is None:
                    ...
                    cross_entropy = cond_loss(fake, self.transformer.output_info_list, c1, m1)
