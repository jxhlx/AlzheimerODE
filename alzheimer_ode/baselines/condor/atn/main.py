...
DEFAULT_DATA_DIR = Path(__file__).resolve().parents[1] / 'data' / 'ATN'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--sampling_epoch', type=int, default=2)
    parser.add_argument('--lr', type=float, default=0.001)
    parser.add_argument('--optim', type=str, default='Adam') 
    parser.add_argument('--num_node', type=str, default=444)
    parser.add_argument('--seed', type=int, default=0)
    parser.add_argument('--classes', type=int, default=5)
    parser.add_argument('--start_time', type=float, default=time.time(), help='start time of training')

    '''ADNI-ATN'''
    parser.add_argument('--dataset', type=str, default='ATN')
    ...
    parser.add_argument('--data_min', type=float, default=0.512, help='minimum value of ATN')
    parser.add_argument('--data_max', type=float, default=4.208, help='maximum value of ATN')
    parser.add_argument('--age_min', type=float, default=60.1, help='minimum value of ATN age')
    parser.add_argument('--age_max', type=float, default=91.1, help='maximum value of ATN age')
