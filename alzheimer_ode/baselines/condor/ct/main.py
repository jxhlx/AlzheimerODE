...
DEFAULT_DATA_DIR = Path(__file__).resolve().parents[1] / 'data' / 'CT'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_min', type=float, default=0.995, help='minimum value of CT')
    parser.add_argument('--data_max', type=float, default=4.25, help='maximum value of CT')
    parser.add_argument('--age_min', type=float, default=60.1, help='minimum value of CT age')
    parser.add_argument('--age_max', type=float, default=91.1, help='maximum value of CT age')
